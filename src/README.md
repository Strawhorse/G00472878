...
- persisted favourites on local storage using Capacitor


## researching ionic functions ....
DONE: Caching the Movie Page
DONE: Ionic can do this, called Ion Router Outlet; by default caches pages. Need to use ionViewWillEnter instead of ngOnInit on pages we want to refresh when needed!!! Don't forget
